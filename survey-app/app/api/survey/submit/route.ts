  ...
  try {
    ...
    const response = await prisma.surveyResponse.create({
      data: {
        ...
        satisfactionOverall: validated.satisfactionOverall,
        momentsThatStoodOut: validated.momentsThatStoodOut,
        mostValuableAspects: validated.mostValuableAspects,
        learningGained: validated.learningGained,
        insightsThatStayed: validated.insightsThatStayed,
        applicationExtent: validated.applicationExtent,
        behaviourChangeExample: validated.behaviourChangeExample,
        objectivesAchieved: validated.objectivesAchieved,
        tangibleOutcomes: validated.tangibleOutcomes,
        npsScore: validated.npsScore,
        npsReason: validated.npsReason,
